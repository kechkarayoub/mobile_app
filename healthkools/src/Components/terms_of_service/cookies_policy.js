        ...
        items: [
            {
                ...
                paragraphs: [
                    {
                        ar: () => <Text style={styles.subTitleTextStyle}>{`المصادقة`}</Text>,
                        en: () => <Text style={styles.subTitleTextStyle}>{`Authentication`}</Text>,
                        fr: () => <Text style={styles.subTitleTextStyle}>{`Authentification`}</Text>,
                        list_items: [
                            {
                                ar: () => {
                                    return <>
                    ...
                    {
                        ar: () => <Text style={styles.subTitleTextStyle}>{`الأمان والموقع وسلامة المنتج`}</Text>,
                        en: () => <Text style={styles.subTitleTextStyle}>{`Security, site and product integrity`}</Text>,
                        fr: () => <Text style={styles.subTitleTextStyle}>{`Sécurité du site et intégrité des produits`}</Text>,
                        list_items: [
                            {
                                ar: () => {
                                    return <>
                    ...
                    {
                        ar: () => <Text style={styles.subTitleTextStyle}>{`الإعلان والتوصيات والرؤى والقياس`}</Text>,
                        en: () => <Text style={styles.subTitleTextStyle}>{`Advertising, recommendations, insights and measurement`}</Text>,
                        fr: () => <Text style={styles.subTitleTextStyle}>{`Publicités, recommandations, statistiques et mesures`}</Text>,
                        list_items: [
                            {
                                ar: () => {
                                    return <>
                    ...
                    {
                        ar: () => <Text style={styles.subTitleTextStyle}>{`ميزات وخدمات الموقع`}</Text>,
                        en: () => <Text style={styles.subTitleTextStyle}>{`Site features and services`}</Text>,
                        fr: () => <Text style={styles.subTitleTextStyle}>{`Fonctionnalités et services du site`}</Text>,
                        list_items: [
                            {
                                ar: () => {
                                    return <>
                    ...
                    {
                        ar: () => <Text style={styles.subTitleTextStyle}>{`الأداء`}</Text>,
                        en: () => <Text style={styles.subTitleTextStyle}>{`Performance`}</Text>,
                        fr: () => <Text style={styles.subTitleTextStyle}>{`Performance`}</Text>,
                        list_items: [
                            {
                                ar: () => {
                                    return <>
                    ...
                    {
                        ar: () => <Text style={styles.subTitleTextStyle}>{`التحليلات والبحث`}</Text>,
                        en: () => <Text style={styles.subTitleTextStyle}>{`Analytics and research`}</Text>,
                        fr: () => <Text style={styles.subTitleTextStyle}>{`Analyse et recherche`}</Text>,
                        list_items: [
                            {
                                ar: () => {
                                    return <>
                    ...
                    {
                        ar: () => <Text style={styles.subTitleTextStyle}>{`مواقع الويب والتطبيقات الخارجية`}</Text>,
                        en: () => <Text style={styles.subTitleTextStyle}>{`Third-party websites and apps`}</Text>,
                        fr: () => <Text style={styles.subTitleTextStyle}>{`Sites web et applications externes`}</Text>,
                        list_items: [
                            {
                                ar: () => {
                                    return <>
            ...
            },
            {
                ...
                paragraphs: [
                    {
                        ar: () => <Text style={styles.subTitleTextStyle}>{`عناصر التحكم في ملفات تعريف الارتباط للمتصفح:`}</Text>,
                        en: () => <Text style={styles.subTitleTextStyle}>{`Browser cookie controls:`}</Text>,
                        fr: () => <Text style={styles.subTitleTextStyle}>{`Contrôle des cookies de navigateur :`}</Text>,
                        list_items: [
                            {
                                ar: () => {
                                    return <>
